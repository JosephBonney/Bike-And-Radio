...
public class ProceduralIKHandler : MonoBehaviour
{
    ...
    float stuntModeHead, stuntModeBody, stuntModeRotation;
    ...
    void Update()
    {
        ...
        stuntModeHead = Mathf.Lerp(stuntModeHead,System.Convert.ToInt32(bicycleController.stuntMode), Time.deltaTime*5);
        headIKTarget.transform.localPosition = new Vector3(bicycleController.customLeanAxis * 1.5f + animatedNoise*bicycleController.pickUpSpeed, 1-(bicycleController.pickUpSpeed*1.5f)+animatedNoise - bicycleController.bunnyHopAmount*0.5f + bunnyHopCounterWeight * 1.5f - stuntModeHead*1.5f,animatedNoise*3) + headOffset + impactDirection*bodyDampingProperties.impactIntensity;
