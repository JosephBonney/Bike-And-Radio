...
namespace Crosstales.RTVoice.Util
{
   ...
   public abstract class Constants : Common.Util.BaseConstants
   {
      ...
      public const string ASSET_VERSION = "2021.3.7";

      /// <summary>Build number of the asset.</summary>
      public const int ASSET_BUILD = 20220106;
      ...
      public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2022, 1, 6);
