...
*/
      ...
      private void deleteAudioFiles(string audioDataPath)
      {
         try
         {
            ...
            string path = Util.Helper.isAndroidPlatform || Util.Helper.isWSABasedPlatform ? Crosstales.Common.Util.FileHelper.ValidatePath(audioDataPath) : Util.Config.AUDIOFILE_PATH;
