...
namespace Crosstales.Radio.OnRadio.Provider
{
   ...
   public class RadioProviderOnRadio : Crosstales.Radio.Provider.BaseRadioProvider
   {
      ...
      [Header("Source Settings")] [Tooltip("OnRadio services from the scene.")] public Crosstales.Radio.OnRadio.Service.BaseService[] Services;
      ...
      {
         foreach (Crosstales.Radio.OnRadio.Service.BaseService service in Services.Where(service => service != null))
         {
      ...
      private void onQueryComplete(string id)
      {
         ...
         foreach (Crosstales.Radio.OnRadio.Model.RadioStationExt station in Services.Where(service => service != null).SelectMany(service => service.Stations))
         {
