...
namespace Crosstales.Radio.OnRadio.Service
{
   ...
   public abstract class BaseService : MonoBehaviour
   {
      ...
      private Crosstales.Radio.OnRadio.Model.ImageResolution Resolution = Crosstales.Radio.OnRadio.Model.ImageResolution.med; //TODO has resolution no effect?
      ...
      public readonly System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RadioStationExt> Stations = new System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RadioStationExt>();
      public readonly System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RecordInfoExt> Records = new System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RecordInfoExt>();
      ...
      private System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RecordInfoExt> recordsByArtistDesc;
      private System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RecordInfoExt> recordsByArtistAsc;
      private System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RecordInfoExt> recordsByTitleDesc;
      private System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RecordInfoExt> recordsByTitleAsc;
      private System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RecordInfoExt> recordsByStationNameDesc;
      private System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RecordInfoExt> recordsByStationNameAsc;
      private System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RadioStationExt> stationsByNameDesc;
      private System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RadioStationExt> stationsByNameAsc;

      private Crosstales.Radio.OnRadio.Model.Stations stationStations;
      private Crosstales.Radio.OnRadio.Model.Songart.Songs songArtSongs;
      private Crosstales.Radio.OnRadio.Model.DARStations.Stations DARStationsStations;
      ...
      public string Query()
      {
         ...
         Debug.LogWarning("No Internet available - can't query OnRadio!", this);
      ...
      /// <returns>UID of the query.</returns>
      public string StationService(Crosstales.Radio.Model.RadioStation station)
      {
         if (Crosstales.Common.Util.NetworkHelper.isInternetAvailable)
         {
            string id = System.Guid.NewGuid().ToString();
         ...
         Debug.LogWarning("No Internet available - can't query Station from OnRadio!", this);
      ...
      /// <returns>UID of the query.</returns>
      public string SongArtService(Crosstales.Radio.Model.RecordInfo record, bool loadIcon)
      {
         if (Crosstales.Common.Util.NetworkHelper.isInternetAvailable)
         {
            string id = System.Guid.NewGuid().ToString();
         ...
         Debug.LogWarning("No Internet available - can't query SongArt from OnRadio!", this);
      ...
      /// <returns>UID of the query.</returns>
      public string DARStationService(Crosstales.Radio.Model.RadioStation station, bool loadIcon)
      {
         if (Crosstales.Common.Util.NetworkHelper.isInternetAvailable)
         {
            string id = System.Guid.NewGuid().ToString();
         ...
         Debug.LogWarning("No Internet available - can't query DARStation from OnRadio!", this);
      ...
      public System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RecordInfoExt> RecordsByArtist(bool desc = false)
      {
         if (desc)
      ...
      public System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RecordInfoExt> RecordsByTitle(bool desc = false)
      {
         if (desc)
      ...
      public System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RecordInfoExt> RecordsByStationName(bool desc = false)
      {
         if (desc)
      ...
      public System.Collections.Generic.List<Crosstales.Radio.OnRadio.Model.RadioStationExt> StationsByName(bool desc = false)
      {
         if (desc)
      ...
      protected IEnumerator queryStation(string id, Crosstales.Radio.Model.RadioStation station, bool isInternal)
      {
         if (!string.IsNullOrEmpty(Token))
         {
            if (station != null)
...
#endif
                  {
                     stationStations = Crosstales.Common.Util.XmlHelper.DeserializeFromString<Crosstales.Radio.OnRadio.Model.Stations>(www.downloadHandler.text, false);
      ...
      private string createStationUrl(Crosstales.Radio.Model.RadioStation station)
      {
         System.Text.StringBuilder sb = new System.Text.StringBuilder();
         sb.Append(stationUrl);
         sb.Append("?");

         if (station.GetType() == typeof(Crosstales.Radio.OnRadio.Model.RadioStationExt))
         {
            sb.Append("station_id=");
            sb.Append(((Crosstales.Radio.OnRadio.Model.RadioStationExt)station).StationId.Trim());
         }
         else
         {
            sb.Append("callsign=");
      ...
      protected IEnumerator querySongArt(string id, Crosstales.Radio.Model.RecordInfo record, bool loadIcon, bool isInternal)
      {
         if (!string.IsNullOrEmpty(Token))
         {
            if (record != null)
...
#endif
                     {
                        songArtSongs = Crosstales.Common.Util.XmlHelper.DeserializeFromString<Crosstales.Radio.OnRadio.Model.Songart.Songs>(www.downloadHandler.text, false);
                        ...
                        if (songArtSongs?.Song != null)
                        {
                           ...
                           if (Crosstales.Common.Util.NetworkHelper.isValidURL(url) && !url.CTContains("onradio-500.png"))
                           {
                              //Debug.Log("LOAD ART: " + url);
                              record.IconUrl = url;

                              if (loadIcon)
                                 yield return Crosstales.Radio.Tool.LoadIcon.Load(record);
                           }
                           else
                           {
                              if (loadIcon)
      ...
      private string createSongArtUrl(Crosstales.Radio.Model.RecordInfo record)
      {
         System.Text.StringBuilder sb = new System.Text.StringBuilder();
         ...
         if (Resolution != Crosstales.Radio.OnRadio.Model.ImageResolution.med)
         {
            sb.Append("&res=");
      ...
      protected IEnumerator queryDARStation(string id, Crosstales.Radio.Model.RadioStation station, bool loadIcon, bool isInternal)
      {
         if (!string.IsNullOrEmpty(Token))
         {
            if (station != null)
...
#endif
                  {
                     DARStationsStations = Crosstales.Common.Util.XmlHelper.DeserializeFromString<Crosstales.Radio.OnRadio.Model.DARStations.Stations>(www.downloadHandler.text, false);

                     if (DARStationsStations?.Station != null)
                     {
                        station.Name = DARStationsStations.Station.Callsign.Trim();
                        station.Description = DARStationsStations.Station.Description.Trim().CTClearLineEndings();
                        station.Genres = DARStationsStations.Station.Genre.Trim().CTClearLineEndings();
                        ...
                        if (Crosstales.Common.Util.NetworkHelper.isValidURL(url))
                        {
                           station.IconUrl = url;
      ...
      private string createDARStationUrl(Crosstales.Radio.Model.RadioStation station)
      {
         System.Text.StringBuilder sb = new System.Text.StringBuilder();
