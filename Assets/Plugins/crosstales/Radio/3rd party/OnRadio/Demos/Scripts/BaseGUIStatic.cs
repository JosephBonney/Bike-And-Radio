...
namespace Crosstales.Radio.OnRadio.Demo
{
   ...
   public abstract class BaseGUIStatic : MonoBehaviour
   {
      ...
      [Header("Settings")] [Tooltip("'RadioPlayer' from the scene.")] public Crosstales.Radio.RadioPlayer Player;
      ...
      protected Crosstales.Radio.OnRadio.Model.RecordInfoExt record;
      ...
      public abstract Crosstales.Radio.OnRadio.Model.RecordInfoExt Record { get; set; }
