            ...
            if (!string.IsNullOrEmpty(script.Station.Url))
            {
               ...
               if (script.Station != null)
               {
                  ...
                  if (!Helper.isEditorMode && !script.LegacyMode)
                  {
                     ...
                     GUILayout.Label("Time:\t\t" + Helper.FormatSecondsToHourMinSec(script.RecordPlayTime));
                  ...
                  if (Helper.isEditorMode)
                     GUILayout.Label("Current Playtime:\t" + Helper.FormatSecondsToHourMinSec(script.Source != null ? script.Source.time : 0f));
                  if (!Helper.isEditorMode)
                     GUILayout.Label($"Total Time:{Constants.TAB}{Helper.FormatSecondsToHourMinSec(script.Station.TotalPlayTime)}");
               ...
               GUILayout.Label($"Total Time:{Constants.TAB}{Helper.FormatSecondsToHourMinSec(Context.TotalPlayTime)}");
