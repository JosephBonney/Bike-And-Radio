      ...
      public string FinalURL
      {
         get
         {
            switch (Prefix)
            {
               ...
               case URLPrefix.File:
                  return Crosstales.Common.Util.NetworkHelper.ValidURLFromFilePath(URL);
               case URLPrefix.PersistentDataPath:
                  return Crosstales.Common.Util.NetworkHelper.ValidURLFromFilePath(Application.persistentDataPath + '/' + URL.Trim());
               case URLPrefix.DataPath:
                  return Crosstales.Common.Util.NetworkHelper.ValidURLFromFilePath(Application.dataPath + '/' + URL.Trim());
               case URLPrefix.TempPath:
                  return Crosstales.Common.Util.NetworkHelper.ValidURLFromFilePath(Constants.PREFIX_TEMP_PATH + URL.Trim());
               default:
                  return URL.Trim();
            }
         }
