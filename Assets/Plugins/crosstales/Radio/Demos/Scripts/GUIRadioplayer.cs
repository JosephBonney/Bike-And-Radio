...
*/
      ...
      {
         if (Manager != null)
            Manager.Filter.BitrateMin = int.TryParse(bitrate, out int _bitrate) ? _bitrate : 32;
      }

      public void FilterBitrateMax(string bitrate)
      {
         if (Manager != null)
            Manager.Filter.BitrateMax = int.TryParse(bitrate, out int _bitrate) ? _bitrate : 500;
      }
      ...
      {
         if (Manager != null)
            Manager.Filter.RatingMin = float.TryParse(rating, out float _rating) ? _rating : 0f;
      }

      public void FilterRatingMax(string rating)
      {
         if (Manager != null)
            Manager.Filter.RatingMax = float.TryParse(rating, out float _rating) ? _rating : 5f;
      }
