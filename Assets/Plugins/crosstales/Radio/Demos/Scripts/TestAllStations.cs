...
namespace Crosstales.Radio.Demo
{
   ...
   public class TestAllStations : MonoBehaviour
   {
      ...
      [Range(1, 10)] public float PlayTime = 3f;

      [Range(1, 5)] public float CleanupTime = 1.5f;
